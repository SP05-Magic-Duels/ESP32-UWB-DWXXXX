 ...
 * ESP-IDF global library (header file) working with the DW1000 library
...
#ifndef DW1000RANGING_H
#define DW1000RANGING_H
...
// Max devices we put in the networkDevices array ! Each DW1000Device is 74 uint8_ts in SRAM memory for now.
#define MAX_DEVICES 4

// Default Pin for module (ESP-IDF GPIO numbers):
#define DEFAULT_RST_PIN (GPIO_NUM_27)
#define DEFAULT_SPI_SS_PIN (GPIO_NUM_5)
