 ...
 *
 * @file DW1000.h
 * ESP-IDF driver library (header file) for the Decawave DW1000 UWB transceiver IC.
 * 
 * @todo
 * - impl: later:
...
//private:
	...
	/* writing numeric values to uint8_ts. */
	...
	/* SPI configs. */
	// Note: Arduino SPISettings removed for ESP-IDF compatibility
	// SPI communication now uses ESP-IDF spi_master.h driver
