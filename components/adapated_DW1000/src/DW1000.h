...
#define SPI_TAG "DW1000_SPI"

/* Helper defines and macros taken from Arduino */
// Resource: https://forum.arduino.cc/t/bitset-and-bitclear/1042506
...
public:
	...
	*/
	...
	/* ESPIDF pins MISO, MOSI, CS, SCLK */
	static gpio_num_t PIN_NUM_MISO;
	static gpio_num_t PIN_NUM_MOSI;
	static gpio_num_t PIN_NUM_CLK;
	static gpio_num_t PIN_NUM_CS;

	/* SPI settings to hold Arduino SPI settings */
	struct SPISettings
	{
		uint32_t clk_speed;
		uint8_t msb_or_lsb_first; // MSBFIRST 1 or LSBFIRST 0
		uint8_t spi_mode;		  // SPI_MODE0 0x00, SPI_MODE1 0x04, SPI_MODE2 0x08, SPI_MODE3 0x0C
	};
	...
	static uint8_t _antennaCalibrated;

	/* internal helper to remember how to properly act. */
	static uint8_t _permanentReceive;
	static uint8_t _frameCheck;
