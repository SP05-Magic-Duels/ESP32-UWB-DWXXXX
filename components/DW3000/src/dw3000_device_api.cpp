...
int dwt_configure(dwt_config_t *config)
{
    ...
    if (flag)
    {
        ESP_LOGI("PLL", "PLL LOCKING ERROR..");
        return DWT_ERROR;
    }
...
int dwt_run_pgfcal(void)
{
    ...
    for (flag = 1, cnt = 0; cnt < MAX_RETRIES_FOR_PGF; cnt++)
    {
        ...
        { // PGF cal is complete
            ESP_LOGI("PGF CAL", "PGF cal complete..");
            flag = 0;
            break;
        }
    }
    if (flag)
    {
        ESP_LOGI("PGF CAL", "PGF CAL ERROR");
        result = DWT_ERROR;
    }
    ...
    {
        // PGF I Cal Fail
        ESP_LOGI("PGF CAL", "PGF I CAL ERROR");
    ...
    {
        // PGF Q Cal Fail
        ESP_LOGI("PGF CAL", "PGF Q CAL ERROR");
        result = DWT_ERROR;
    }
